...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/EXPO2024/view/admin/';
    ...
    */
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['idProfesor']) and Validator::validateSessionTime()) {
            ...
            $this->setTitle('SGE - Reporte', true);
    ...
    */
    ...
    {   
        ...
        $profesor = new ProfesorHandler();
        $usuario_info = $profesor->readProfile();
        // Fondo superior derecho
        $this->image('../../images/fondo_superior_derecho.png', 128, 0, 148);
    
        // Logo
        $this->image('../../images/logo.png', 15, 0, 30);

        // Fondo inferior derecho
        $this->image('../../images/fondo_inferior_derecho.png', 0, 180, 216, 100);
    
        // Título
        $this->setFont('Arial', 'B', 15);
        $this->cell(136, 10, $this->encodeString($this->title), 0, 1, 'C');
    
        // Fecha y hora
        $this->setFont('Arial', '', 10);
        $this->cell(136, 5, 'Fecha/Hora: ' . date('d-m-Y H:i:s'), 0, 1, 'C');
        ...
        $this->cell(0, 10, $this->encodeString('Información del profesor'), 0, 1, 'L');
        $this->setFont('Arial', '', 12);
        $this->cell(0, 7, 'Correo: ' . $usuario_info['correo_profesor'], 0, 1, 'L');
        $this->cell(0, 7, 'Nombre: ' . $usuario_info['nombre_profesor'], 0, 1, 'L');
