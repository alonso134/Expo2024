            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning" onclick="openReportP(${row.id_materia})">
...
const openReport = () => {
    ...
    const PATH = new URL(`${SERVER_URL}reports/admin/materias.php`);
...
const openReportP = (id) => {
    // Se declara una constante tipo objeto con la ruta específica del reporte en el servidor.
    const PATH = new URL(`${SERVER_URL}reports/admin/notas_materia.php`);
